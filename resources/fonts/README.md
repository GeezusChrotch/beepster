# Beepster Time 2 fonts

Beepster uses the same five-font set as Pome from the Google Fonts repository for the
Pebble Time 2 build. Each family is compiled at 14, 18, 22, 26, and 30 points using the printable
